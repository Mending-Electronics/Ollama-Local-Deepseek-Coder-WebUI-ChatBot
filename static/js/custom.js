  ...
  function toggleThemeMenu() {
    ...
    document.querySelectorAll('[data-bs-theme-value]').forEach(value => {
      value.addEventListener('click', () => {
        ...
        // Add or update the style element in the head
        ...
        if (theme == "light") {
          ...
          // Loop through the NodeList and apply any desired actions
          for (const element of tileLogoElements) {
              // Add styles (filter: invert(0.5) brightness(1.5))
              element.style.filter = "grayscale() contrast(0.5) brightness(1.3)";
          }
